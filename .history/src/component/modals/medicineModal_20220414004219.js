    ...
    return (
      <div>
       ...
       <Link  to='#' onClick={this.hideModal.bind(this)} className='mx-2  text-decoration-none text-dark '>X</Link>
        ...
        <Offcanvas isOpen={this.props.isopen}>
      
          <Link  to='/pharmacy' onClick={this.hideModal.bind(this)} className='mx-2  text-decoration-none text-dark '>X</Link>
          <Offcanvas.Body>

              <div className="row"><h3 className="m-3 text-success text-center">Buy Medicine</h3></div>
            <div className="row">
