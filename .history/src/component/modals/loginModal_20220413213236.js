      ...
      <div >
        <div>
          ...
          >
            ...
            <Link  to='#' onClick={this.close.bind(this)} className='text-left mx-2  text-decoration-none text-dark '><button className="float-right btn btn-secondary">X</button></Link>
