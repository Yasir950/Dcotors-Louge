...
export default class Addtocart extends Component {
  ...
  onCancelClick(obj, index) {
    ...
    console.log(filter);
        ...
        let filtered = medicalArr.splice(index, 1);
      ...
      <div>
              ...
              {this.state.medArr.map((item, index) => (
                <tr>
                  ...
                  {this.state.addcart===false ?(
                        ...
                        <button
                          className="btn btn-link  text-decoration-none text-danger btn-outline-light"
                          onClick={this.onCancelClick.bind(this, item, index)}
                        >
                         <i class="fas fa-solid fa-trash fa-sm"></i>
                        </button>
                      </td>
                  ):(
                    <td className="text-danger">
                    <button
                      className="btn btn-link  text-decoration-none text-white btn-outline-light"
                      disabled
                      onClick={this.onCancelClick.bind(this, item, index)}
                    >
                      X
        ...
        <div className="col-12 mb-3  text-center">
          {this.state.checkout === false ? (
            ...
            >
                  <button className="btn btn-sm w-100 btn-success  " onClick={this.onAppointClick.bind(this)}>Check Out</button>
