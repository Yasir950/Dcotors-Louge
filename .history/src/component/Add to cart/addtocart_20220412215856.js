             ...
             <div className="col-4">
              ...
              <div className='row '>
                    ...
                    <div className="col-6  d-inline-flex text-center  ">
                        <div className=" py-0">
                            {this.state.count===0 ?(
                        <h5 className='mx-3 btn btn-secondary ' disabled onClick={this.onMinClick.bind(this)}>-</h5>

                            )::(
                        <h5 className='mx-3 btn btn-secondary ' onClick={this.onMinClick.bind(this)}>-</h5>
