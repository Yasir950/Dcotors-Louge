...
export default class MedInfo extends Component {
  ...
  Save() {
    ...
    let picsArray=this.state.picArr
    picsArray.push(this.state.src)
          ...
          {this.state.update === true && (
            <div className="form-control ">
              ...
              <div className="mb-3">
                ...
                <input className="form-control" type="file" id="src" onChange={this.onChange.bind(this)}/>
              </div>
