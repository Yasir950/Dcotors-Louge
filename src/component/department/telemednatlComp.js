          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-6 text-center">
                <div>
                  <h2 className="text-primary mb-4">TeleMedicine National</h2>
            ...
            {/* <div className="row d-flex justify-content-center ">
              ...
              {this.state.selectedsearch==='gender' && (
                   <div className="col-8 ">
                   <select
                       class="form-select form-select-lg mb-3"
                       id='searchInput'
                     ...
                     {/* <button  className="btn btn-lg btn-success float-end" onClick={this.onChange.bind(this)} style={{marginTop:'-49px'}}>Search</button> */}
            {/* </div>
              )}
              {this.state.selectedsearch==='rating' && (
                   <div className="col-8 ">
                   <select
                       class="form-select form-select-lg mb-3"
                       id='searchInput'
            ...
            {/* </div>
               ...
               {this.state.selectedsearch==='priceRange' && (
                   <div className="col-8 ">
                   <select
                       class="form-select form-select-lg mb-3"
                       id='searchInput'
                       ...
                       onChange={this.onChange.bind(this)}
                     >
                      { this.state.priceRangeArr.map((item)=>(
                       <option>{item}</option>
                       ))}
                     </select>
                     {/* <button  className="btn btn-lg btn-success float-end" onClick={this.onChange.bind(this)} style={{marginTop:'-49px'}}>Search</button> */}
            {/* </div>
                 ...
                 {this.state.selectedsearch==='speciality' && (
                   <div className="col-8 ">
                   <select
                       class="form-select form-select-lg mb-3"
                       id='searchInput'
            ...
            {/* </div>
                 ...
                 {this.state.selectedsearch==='responceTime' && (
                   <div className="col-8 ">
                   <select
                       class="form-select form-select-lg mb-3"
                       id='searchInput'
                       ...
                       onChange={this.onChange.bind(this)}
                     >
                      { this.state.responceTimeArr.map((item)=>(
                       <option>{item}</option>
                       ))}
                     </select>
                     {/* <button  className="btn btn-lg btn-success float-end" onClick={this.onChange.bind(this)} style={{marginTop:'-49px'}}>Search</button> */}
            ...
            <div className="row  mb-3">
              <div className="col-4">
                <h3 className="mb-3">TeleMedicine National</h3>
              </div>
              <div className="col-8">
                {this.state.specialityArr.map((item) => (
